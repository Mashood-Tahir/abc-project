                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        <div class="item-title">WEEKLY</div>
                                        <span>SALES</span>
                            ...
                            <div class="card-body">
                                ...
                                <div class="student-report">
                                    <div class="student-count pseudo-bg-blue">
                                        <h4 class="item-title">Female Customers</h4>
                                        <div class="item-number">45,000</div>
                                    </div>
                                    <div class="student-count pseudo-bg-yellow">
                                        <h4 class="item-title">Male Customers</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="notice-box-wrap">
                                    <div class="notice-list">
                                        ...
                                        <h6 class="notice-title"><a href="#">Traveling is one of the best ways to open your mind and heart to the world. As a result, I’ve experienced the full range of emotions during my travels.</a></h6>
                                        <div class="entry-meta"> Jennyfar Lopez / <span>5 min ago</span></div>
                                    </div>
                                    <div class="notice-list">
                                        <div class="post-date bg-yellow">16 June, 2019</div>
                                        <h6 class="notice-title"><a href="#">Travel is  fatal to prejudice, bigotry, and narrow mindedness., and many of our people need it sorely on these accounts.</a></h6>
                                        <div class="entry-meta"> Jennyfar Lopez / <span>5 min ago</span></div>
                                    </div>
                                    <div class="notice-list">
                                        <div class="post-date bg-pink">16 June, 2019</div>
                                        <h6 class="notice-title"><a href="#">Great things never came from comfort zones.</a></h6>
                                        <div class="entry-meta"> Jennyfar Lopez / <span>5 min ago</span></div>
                                    </div>
                                    <div class="notice-list">
                                        <div class="post-date bg-skyblue">16 June, 2019</div>
                                        <h6 class="notice-title"><a href="#">Stop worrying about the potholes in the road and enjoy the journey.</a></h6>
                                        <div class="entry-meta"> Jennyfar Lopez / <span>5 min ago</span></div>
                                    </div>
                                    <div class="notice-list">
                                        <div class="post-date bg-yellow">16 June, 2019</div>
                                        <h6 class="notice-title"><a href="#">I travel not to go anywhere but to go. I travel for travel's sake.</a></h6>
                                        <div class="entry-meta"> Jennyfar Lopez / <span>5 min ago</span></div>
                                    </div>
                                    <div class="notice-list">
                                        <div class="post-date bg-pink">16 June, 2019</div>
                                        <h6 class="notice-title"><a href="#">Live with no excuses and travel with no regrets.</a></h6>
                                        <div class="entry-meta"> Jennyfar Lopez / <span>5 min ago</span></div>
                                    </div>
                                </div>
                            </div>
